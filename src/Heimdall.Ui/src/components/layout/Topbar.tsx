    ...
    >
      <div className="flex min-w-0 shrink-0 flex-col gap-1.5 sm:min-w-[200px]">
        <div className="flex items-center gap-2">
          <svg viewBox="0 0 64 64" width="24" height="24" aria-hidden="true" className="shrink-0">
            <path
              d="M32 9 L50 16 V32 C50 44 42 52 32 56 C22 52 14 44 14 32 V16 Z"
              fill="none"
              stroke="url(#hmark)"
              strokeWidth="3.5"
              strokeLinejoin="round"
            />
            <circle cx="32" cy="31" r="6.5" fill="none" stroke="currentColor" strokeWidth="3" />
